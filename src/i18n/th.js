...
export default {
  ...
  // "ติดตั้งแอพ" (PWA) — banner (มือถือ) + ปุ่ม top-bar (เดสก์ท็อป) + คำแนะนำ iOS
  install: {
    button: 'ติดตั้งแอพ',
    chip: 'ติดตั้ง',
    bannerTitle: 'ติดตั้งเป็นแอพ',
    bannerSub: 'เปิดเร็วขึ้น ใช้ออฟไลน์ได้ เหมือนแอพจริง',
    bannerCta: 'ติดตั้ง',
    dismiss: 'ปิด',
    close: 'ปิด',
    iosTitle: 'ติดตั้งบน iPhone/iPad',
    iosStep1: 'แตะปุ่มแชร์ด้านล่างของ Safari',
    iosStep2: 'เลือก “เพิ่มไปยังหน้าจอหลัก”',
    iosStep3: 'แตะ “เพิ่ม” มุมขวาบน',
    gotIt: 'เข้าใจแล้ว',
  },
  a11y: {
