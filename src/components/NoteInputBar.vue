...
<template>
  <div class="nib no-print" :class="{ 'nib-wide': wide }" role="toolbar" aria-label="เครื่องมือแก้โน้ต" @mousedown.prevent>
    ...
    <div v-if="helpOpen" class="nib-helpbox" role="note">
      ...
      <b>Insert</b> สลับ ทับ↔แทรก (แทรก = เคอร์เซอร์เป็นขีดกะพริบระหว่างโน้ต แทรกโน้ตใหม่ได้ แม้หน้าตัวแรก)<br />
      <b>Backspace</b> ลบโน้ตทางซ้าย · <b>Delete</b> ลบโน้ตทางขวา · พิมพ์ <b>0</b> = ตัวหยุด<br />
