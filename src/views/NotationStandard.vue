...
const COMBOS = [
  ...
  ["(.6_5'_)", "(.6_5'_)", 'เอื้อนของโน้ตผสม — ทุกอย่างซ้อนกันได้ (โน้ตติดกันในช่องเดียว = เอื้อนคำเดียว)'],
]
        ...
        <table class="guide-table">
          ...
          <tbody>
            ...
            <tr>
              <td><code>(.6_.7_)</code></td>
              <td class="render-cell"><NoteRow notes="(.6_.7_)" /></td>
              <td>เอื้อนคำเดียว — โน้ตติดกันใน<strong>ช่องเดียว</strong> นับเป็น 1 คำ · เอื้อนสั้น<strong>ในจังหวะเดียว</strong>
                แบบนี้ <strong>ไม่มีเส้นโค้ง</strong> เพราะเส้นใต้ที่เชื่อมกันบอกแทนแล้ว (เส้นโค้งจะขึ้นเมื่อเอื้อน<strong>คร่อมเกิน 1 จังหวะ</strong>
                หรือเป็น<strong>เลขซ้ำ</strong>)</td>
            </tr>
          </tbody>
        </table>
      </div>
