    ...
    <div class="card" id="howto">
      ...
      <ul>
        ...
        <li><strong>✏️ แก้บนแผ่นเพลงได้เลย</strong> — กดปุ่มดินสอมุมขวาล่างเพื่อเข้าโหมดแก้
          ...
          <br /><span class="muted">ใครก็แก้ได้ — จะเก็บถาวรเข้าคลังค่อยเข้าสู่ระบบ (ตอนนี้พิมพ์เลขได้บนคอมพิวเตอร์
          ที่มีคีย์บอร์ด · แป้นพิมพ์ตัวเลข/สัญลักษณ์บนมือถือกำลังจะตามมา)</span></li>
