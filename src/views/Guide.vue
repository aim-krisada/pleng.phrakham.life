    ...
    <div class="card" id="howto">
      ...
      <ul>
        ...
        <li><strong>✏️ แก้บนแผ่นเพลงได้เลย</strong> — กดปุ่มดินสอมุมขวาล่างเพื่อเข้าโหมดแก้
          ...
          <br /><span class="muted">พอเข้าโหมดแก้จะมี<strong>แถบปุ่มด้านล่างจอ</strong> — เลข 1–7 · สูง/ต่ำ (ขึ้น-ลงหนึ่งช่วงเสียง) ·
          ♯ ♭ · แทรก/ทับ · ลบ · ตัวหยุด — <strong>ใช้แก้บนมือถือได้เลยไม่ต้องมีคีย์บอร์ด</strong>
          (บนคอมพิวเตอร์จะกดจากคีย์บอร์ดหรือแถบนี้ก็ได้) · ใครก็แก้ได้ จะเก็บถาวรเข้าคลังค่อยเข้าสู่ระบบ</span></li>
