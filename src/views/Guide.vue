      ...
      <ul>
        ...
        <li><strong>✏️ แก้บนแผ่นเพลงได้เลย</strong> — กดปุ่มดินสอมุมขวาล่างเพื่อเข้าโหมดแก้
          ...
          <ul>
            ...
            <li><strong>Backspace</strong> = ลบโน้ตที่เลือกทิ้ง โน้ตที่เหลือเลื่อนมาชิด (ดึงชิด) ·
              <strong>Delete</strong> = เปลี่ยนโน้ตเป็น<strong>ตัวหยุด</strong> (เงียบ 1 จังหวะ) ตำแหน่งอื่นไม่ขยับ</li>
