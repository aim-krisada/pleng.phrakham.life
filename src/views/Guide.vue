...
const SYMBOLS = [
  ...
  ['(6 5)', '(6 5)', 'เส้นโค้ง = สลัวร์ (slur) เสียงเอื้อน ร้องคำเดียวลากหลายโน้ต ได้ยินทุกโน้ต — ถ้าเป็นเขบ็ต เส้นใต้จะต่อเป็นเส้นเดียวให้ด้วย (ดูหัวข้อเสียงเอื้อนด้านล่าง)'],
...
<template>
  <div>
    ...
    <div class="card">
      ...
      <p>
        <strong>สลัวร์</strong> = เส้นโค้งครอบโน้ต<strong>คนละเสียง</strong> ร้องคำเดียวลากหลายโน้ต
        (เอื้อน) — ตอนกดฟังจะ<strong>ได้ยินทุกโน้ต</strong> · วิธีพิมพ์: ใส่<strong>วงเล็บครอบ</strong>
        ระบบจะวาดเส้นโค้งด้านบน ถ้าเป็นเขบ็ตก็<strong>ต่อเส้นใต้ให้ติดกันเป็นเส้นเดียว</strong>เหมือนหนังสือ
        (เขบ็ตธรรมดาคนละพยางค์ เส้นใต้จะแยกกันมีช่องไฟ):
      </p>
      <div style="overflow-x: auto">
        <table class="guide-table">
          <thead>
      ...
      <h3>เสียงลากข้ามห้อง — ไท (tie) <code>~</code></h3>
      <p>
        <strong>ไท</strong> ต่างจากสลัวร์ตรงที่เป็น<strong>เสียงเดียวกันเป๊ะ</strong>
        ลากต่อเป็นเสียงเดียว — <strong>ไม่ดีดซ้ำ</strong> · ใช้เมื่อเสียงเดียวลากยาวข้ามเส้นกั้นห้อง
        (เช่น "น้ำ" ในเพลงที่ 1) ให้พิมพ์ <code>~</code> <strong>ท้าย</strong>โน้ตตัวแรก
        และ <code>~</code> <strong>หน้า</strong>โน้ตตัวรับในห้องถัดไป:
      </p>
      <div style="overflow-x: auto">
        <table class="guide-table">
          <thead>
