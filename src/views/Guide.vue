      ...
      <ul>
        ...
        <li><strong>✏️ แก้บนแผ่นเพลงได้เลย</strong> — กดปุ่มดินสอมุมขวาล่างเพื่อเข้าโหมดแก้
          ...
          <ul>
            ...
            <li><strong>ลบ (Backspace/Delete หรือปุ่ม ⌫)</strong> = ลบเฉพาะสิ่งที่เลือก:
              อยู่ที่<strong>โน้ต</strong> → โน้ตกลายเป็น<strong>ตัวหยุด</strong> (เงียบ) คำใต้โน้ตยังอยู่ ·
              อยู่ที่<strong>คำ</strong> → ลบเฉพาะคำนั้น โน้ตยังอยู่ · ตำแหน่งอื่นและข้ออื่นไม่ขยับ</li>
