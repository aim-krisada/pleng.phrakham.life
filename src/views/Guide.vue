      ...
      <ul>
        ...
        <li><strong>✏️ แก้บนแผ่นเพลงได้เลย</strong> — กดปุ่มดินสอมุมขวาล่างเพื่อเข้าโหมดแก้
          ...
          <ul>
            ...
            <li><strong>เดินด้วยคีย์บอร์ดล้วน</strong> (ไม่ต้องใช้เมาส์): <strong>← →</strong> เดินทีละหน่วย
              โน้ต → คำของโน้ตนั้น → โน้ตถัดไป… · <strong>↑ ↓</strong> ข้ามบรรทัด ·
              <strong>Ctrl+← →</strong> ข้ามทีละห้อง · <strong>Ctrl+↑ ↓</strong> ข้ามทีละท่อน
              <br /><span class="muted">บนมือถือใช้ปุ่ม <strong>◀ ▶</strong> ในแถบล่างแทนลูกศร (เดินโน้ต↔คำเหมือนกัน)</span></li>
          </ul>
