...
<template>
  <div>
    ...
    <div class="card">
      ...
      <p>
        <strong>① เอื้อน (สลัวร์) — หลายโน้ตในคำเดียว:</strong> พิมพ์รวมใน<strong>ช่องเดียว</strong>
        แล้วใส่วงเล็บครอบ เช่น <code>(6 5)</code> · ใช้กับโน้ตแบบไหนก็ได้ (เขบ็ต 1 ชั้น, 2 ชั้น, หรือธรรมดา)
      </p>
      <p>
