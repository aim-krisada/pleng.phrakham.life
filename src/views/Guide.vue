    ...
    <div class="card" id="howto">
      ...
      <ul>
        ...
        <li><strong>✏️ แก้บนแผ่นเพลงได้เลย</strong> — กดปุ่มดินสอมุมขวาล่างเพื่อเข้าโหมดแก้
          ...
          <br /><span class="muted">พอเข้าโหมดแก้จะมี<strong>แถบปุ่ม</strong>ให้กด — เลข 1–7 · สูง/ต่ำ (ขึ้น-ลงหนึ่งช่วงเสียง) ·
          ♯ ♭ · แทรก/ทับ · ลบ · ตัวหยุด — <strong>ใช้แก้บนมือถือได้เลยไม่ต้องมีคีย์บอร์ด</strong>
          (บนมือถือแถบอยู่ด้านล่างจอ · บนคอมพิวเตอร์เป็นกล่องลอยติดโน้ตที่เลือก จะกดคีย์บอร์ดหรือแตะแถบก็ได้) ·
