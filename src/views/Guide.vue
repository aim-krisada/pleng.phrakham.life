    ...
    <div class="card" id="howto">
      ...
      <ul>
        ...
        <li><strong>✏️ แก้บนแผ่นเพลงได้เลย</strong> — กดปุ่มดินสอมุมขวาล่างเพื่อเข้าโหมดแก้
          แล้ว<strong>แตะโน้ต</strong>ที่อยากเปลี่ยน จากนั้น<strong>พิมพ์เลข 1–7</strong> โน้ตจะเปลี่ยนทันทีบนแผ่นเพลง
          (ใช้ลูกศรหรือเว้นวรรคเลื่อนไปโน้ตถัดไป) กดดินสออีกครั้งเพื่อออก
