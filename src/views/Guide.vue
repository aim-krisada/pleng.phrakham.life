...
const SYMBOLS = [
  ...
  ['#4  b7', '#4 b7', 'ชาร์ป (สูงขึ้นครึ่งเสียง) / แฟลต (ต่ำลงครึ่งเสียง) — พิมพ์หน้าหรือหลังตัวเลขก็ได้ ระบบจัดตำแหน่งให้เอง'],
  ['(6 5)', '(6 5)', 'เส้นโค้ง = เสียงเอื้อน ร้องคำเดียวลากหลายโน้ต — ถ้าเป็นเขบ็ต เส้นใต้จะต่อเป็นเส้นเดียวให้ด้วย (ดูหัวข้อเสียงเอื้อนด้านล่าง)'],
  ['{1 2 3}', '{1 2 3}', 'สามพยางค์ (triplet) = โน้ต 3 ตัวในเวลาของ 2 ตัว'],
  ['3^', '3^', 'เฟอร์มาตา (โค้งมีจุดเหนือโน้ต) = ยืดเสียงยาวกว่าปกติ ตามผู้นำเพลง — ตอนกดฟัง เสียงจะลากยาวขึ้นให้'],
]
...
<template>
  <div>
    ...
    <div class="card">
      ...
      <h3>เสียงเอื้อน — เส้นใต้ติดกันเป็นเส้นเดียว</h3>
      <p>
        เขบ็ตธรรมดาที่<strong>คนละพยางค์</strong> เส้นใต้จะ<strong>แยกกัน</strong>มีช่องไฟ
        แต่ถ้าเป็น<strong>เสียงเอื้อน</strong> (คำเดียวร้องลากหลายโน้ต)
        ให้ใส่<strong>วงเล็บครอบ</strong> — ระบบจะวาดเส้นโค้งด้านบน
        และ<strong>ต่อเส้นใต้ให้ติดกันเป็นเส้นเดียว</strong>เหมือนหนังสือ:
      </p>
      <div style="overflow-x: auto">
        <table class="guide-table">
          <thead>
          ...
          <tbody>
            <tr>
              ...
              <td>สองพยางค์ — เส้นใต้แยกกัน มีช่องไฟ</td>
            </tr>
            <tr>
              <td><code>(.6_ .7_)</code></td>
              <td class="render-cell"><NoteRow notes="(.6_ .7_)" /></td>
              <td>เสียงเอื้อนพยางค์เดียว — เส้นโค้งบน + เส้นใต้ต่อเป็นเส้นเดียว</td>
            </tr>
          </tbody>
        </table>
      </div>
