...
> 1. **ลากปรับ *ขนาด* dock free-form** (วันนี้มีแค่ *ย้าย* ไม่มี resize) — desktop = ลากขอบ · mobile = **สไลเดอร์ขนาด** (ฟันธง: touch ลากมุมเล็งยาก · SOP §1)
...
**⛔ ไม่ใช่ 3 preset (กะทัดรัด/สบาย/ใหญ่) — P'Aim สั่ง free-form (ต่อเนื่อง):**

| platform | ท่า | กลไก |
|---|---|---|
| **desktop (เมาส์)** | **ลากขอบ/มุม dock** ต่อเนื่อง | resize handle (วันนี้มีแค่ move by grip · เพิ่ม resize) |
| **มือถือ (นิ้ว)** | **สไลเดอร์ขนาด** ในหน้าตั้งค่าเต็มจอ | reuse แพทเทิร์นสไลเดอร์โปร่งใส `:386` (touch-safe · ต่อเนื่องเหมือนลากขอบ) |
| ทั้งคู่ | **พื้นขั้นต่ำ 44px** | scale clamp — ปุ่มไม่เล็กกว่า 44px (WCAG) |
