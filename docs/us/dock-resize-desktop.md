...
## 🔴 กลับมาแก้ รอบ 3 (18 ก.ค. · P'Aim ลอง preview febda9a · พินแดง+กระพริบ OK ✅ เจอ 2 ปรับ)
1. 🔴 **⚙ ต้องแสดง "ทุกปุ่ม" (ไม่ใช่แค่ manageable subset)** → ทุกปุ่มบนแถบมีแถวใน ⚙ พร้อม 📌 พินแดง (in/out) + ▲▼ (จัดตำแหน่ง) · **safety: gear/grip ย้ายได้ แต่ถอนไม่ได้ (หรือถอนแล้วมีทางกลับ) ห้าม strand** · keypad = คงเป็นชุด
2. 🔴 **hug-content สูง — ห้ามเหลือที่ว่างแนวตั้งเปล่า** (P'Aim: "ปรับสูงที่ว่างเต็มควรแคบได้") → dock สูง = พอดีเนื้อหา · ลากสูงเกิน content = ยุบชิด content
...
- [ ] **⚙ แสดงทุกปุ่ม + พิน/จัดลำดับได้ทุกปุ่ม** (gear/grip ย้ายได้ถอนไม่ได้) · **ไม่มีที่ว่างแนวตั้งเปล่า (hug content)**
