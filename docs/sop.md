...
idea → SA: US+DS+mockup (อิง ui-standards+self-audit)
     → 🚦GATE0 PM verify DESIGN ก่อนถึง P'Aim (บังคับ · บทเรียน 18 ก.ค.):
            PM **เปิด mockup + เทียบแอปจริง** (อ่าน component จริง) + เช็ก SOP §4 exists-vs-new
            (ของเดิมดีอยู่แล้ว = ห้ามเสนอใหม่ · โชว์เฉพาะ DELTA · ปุ่ม/ฟีเจอร์ครบ ไม่หาย)
            ✗ = ตีกลับ SA/UX เอง · P'Aim เห็นเฉพาะที่ PM verify แล้ว (⛔ ห้าม relay ลิงก์ดิบ)
...
8. **⛔ ห้าม relay งาน (mockup/report) ให้ P'Aim โดย PM ไม่เปิดเทียบแอปจริงเอง** (บทเรียน 18 ก.ค. · dock-config) — ส่ง mockup ที่ปุ่ม ⚙ หาย+เพี้ยน+ออกแบบทับของเดิมที่ดีอยู่แล้ว เพราะ PM แค่ส่งลิงก์ต่อไม่ได้เปิดดู · P'Aim เจอของห่วย = PM gate พัง (GATE0) · **PM = ที่ปรึกษาที่เข้าใจระบบ ต้องอ่าน component จริงก่อนเชื่อ mockup ของสาย** · "ของเดิมดีอยู่แล้ว" (P'Aim ชี้ภาพ) = ห้ามออกแบบใหม่ เอาแค่ DELTA
