...
- **cap/แถว:** mobile ≤ **6** (ปุ่ม 44px ผ่าน WCAG 2.2 AA · รองรับจอ 320px) · desktop ≤ **14**
- ยาวของ dock = ตามปุ่ม default + ที่เลือกแสดง · เกิน cap → ขึ้นแถวใหม่ (บน) / พับเข้า ⋯
...
| timeslide | ไทม์ไลน์ | timeline | row2 · col1 span3 | onDock | สถานะเล่นปัจจุบัน + เลื่อนหา |
...
I3  ปุ่ม/แถวเพิ่ม → ขึ้นแถวบน · row1 (grip..setting) ไม่ขยับ
...
I6  cap: mobile 6 (44px WCAG 2.2 AA) · desktop 14 · เกิน = ขึ้นแถว/⋯
I7  เปิดทีละ 1 · Esc/แตะนอก = ปิด · tap ≥ 44px · aria-label ทุกปุ่ม
```
