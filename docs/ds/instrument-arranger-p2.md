...
- **default:** หน้าแก้ไข = ทำนอง+คอร์ด · เดี่ยว(เปียโน) · **ลูกเล่นปิด** (ตรวจโน้ต) · หน้าเล่น = **ลูกเล่นเปิด** (P'Aim เคาะ).
