...
| B002 | ปรับปรุง | เปลี่ยนชื่อโหมด: ดู→**ฝึกร้อง** · แผ่น→**แผ่นเพลง** · แก้→**แก้ไข** | ภาพ: `backlog-assets/B002-mode-labels.png` · **✅ พี่เอมเคาะ 2026-07-08: ฝึกร้อง · แผ่นเพลง · แก้ไข** (เหตุผล: "พิมพ์"/"ทำเพลง" เป็น action/ซ้ำเมนูเว็บ → ใช้ชื่อโหมดที่ชัด) · รวมเข้า **wt0-followups US-05** (แถบปุ่มโหมดเดียวกัน) | picked | WT-0 US-05 |
