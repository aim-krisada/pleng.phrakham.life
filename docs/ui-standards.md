...
- **ห้ามตีกรอบเส้นซ้อนใน container ที่มีกรอบอยู่แล้ว (nested-border anti-pattern):** dock = การ์ดมีกรอบ+เงาอยู่แล้ว → ใส่กรอบเส้นรอบ control ข้างในอีก = กล่องซ้อนกล่อง ดูเชย/อึดอัด (ขัด minimalist · slider ตามมาตรฐาน Material/APG ไม่มีกรอบ ตัวรางคือ container) · ถ้าต้องจับกลุ่มให้ดูเป็นสัดส่วน = ใช้ **Gestalt common region แบบเบา** (well/พื้นจาง หรือ spacing) ไม่ใช่เส้นกรอบแข็ง (P'Aim เคาะไม่ทำกรอบ timeline 11 ก.ค.)
