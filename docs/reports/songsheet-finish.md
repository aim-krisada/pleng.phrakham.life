...
## ✅ P'Aim print PDF จริงยืนยันแล้ว (10 ก.ค. · เพลง 100 · 2 หน้า)

ตรวจจากไฟล์ PDF จริง `Downloads/เพลง.พระคำ.ชีวิต - ขอสรรเสริญพระเจ้าโดยไม่หยุดยั้ง.pdf` (ไม่เคลมจาก DOM):
- **B004:** ชื่อไฟล์ = ชื่อเพลง ✅ · หัวกลาง "100. ขอสรรเสริญ…" ✅ · footer ทั้ง 2 หน้า = ซ้าย "เพลง.พระคำ.ชีวิต" ·
  กลาง **"หน้า 1 ของ 2" / "หน้า 2 ของ 2"** · ขวา "พิมพ์เมื่อ 10 ก.ค. 69" ✅ · margin ไม่ตกขอบ · **ร้อง 3 ขึ้นหน้า 2
  ไม่ตัดกลางท่อน** ✅
- **B069:** ไทข้ามห้องเรนเดอร์เป็น **โค้งเดียวพาดข้ามเส้นห้อง** บนกระดาษจริง (เห็นชัดที่ ร้อง 2 "เลิศ กว่า⌢…" +
  ท้าย "1 - - - | 1" ทุกท่อนที่ซ้ำทำนอง A) ✅
- **B044:** โน้ต+คำเป็นก้อนเดียว (แน่น) · บรรทัด/ท่อนแยกชัด ✅
