...
- **B001 (feature) ปุ่มขึ้นบนสุด/ลงล่างสุด:** ✅ ปุ่มลอยมุมล่างขวา (แคปซูล ↑/↓) — **↑ = ไปบนสุด · ↓ = ไปล่างสุด** แบบ smooth (behavior เดียวกับ phrakham.life ตามที่พี่เอมเคาะ) · โผล่เฉพาะหน้าที่เลื่อนได้ · หรี่ปุ่มที่ไปต่อไม่ได้ (บนสุด/ล่างสุด) · ไม่พิมพ์ · ยืมสไตล์/แพตเทิร์นจาก FAB ของ phrakham.life (fixed + safe-area + เงา + สีแบรนด์)
