...
- **B001 (feature) ปุ่มขึ้นบนสุด/ลงล่างสุด:** ✅ ปุ่มลอยมุมล่างขวา **วงกลม 2 อัน (↑/↓)** สไตล์เดียวกับ พระคำ.ชีวิต — **↑ = ไปบนสุด · ↓ = ไปล่างสุด** แบบ smooth · **พักตัวจาง (opacity 0.45) แล้วชัดเต็มตอนเลื่อน/ชี้เมาส์ จางกลับหลัง idle ~1.6 วิ** · โผล่เฉพาะหน้าที่เลื่อนได้ · หรี่ปุ่มปลายทางที่ไปต่อไม่ได้ · ไม่พิมพ์ · fixed + safe-area + เงา + สีแบรนด์
