...
- **`category` เป็น free-text · taxonomy "เลี้ยงได้" ไม่ล็อกตายตัว** (B095 · P'Aim) — เพิ่มเล่มใหม่ =
  ใส่ code ใหม่ได้ ไม่ต้องแก้ schema · หน้าแก้ไข**เสนอ 3 เล่ม canonical เป็นตัวเลือกหลัก** (เล่มใหญ่/อนุชน/เด็กเล็ก)
  **แต่พิมพ์ชื่อเล่มใหม่เองได้** (`allow-custom` — เพิ่มเล่มที่ 4/เปลี่ยนชื่อโดยไม่ต้องแก้โค้ด) · ชื่อสวยเติมใน `bookshelf.js`;
  code ที่ไม่รู้จักยังแสดงดิบ ๆ ไม่พัง
