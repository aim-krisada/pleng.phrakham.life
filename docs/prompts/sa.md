...
- ประสาน dev sessions · ตัดสิน **merge กลับฐาน** · อัปเดต `docs/status.md` ทุกครั้งที่มีอะไรเปลี่ยน
...
- **US = สิ่งที่พี่เอม approve เป็นหลัก** → ส่วน "เล่าเป็นภาษาคน" ของทุก US ต้องอ่านรู้เรื่องทันที (ม.ต้น + flow). รายละเอียดเทคนิคอยู่ใน DS ไม่ใช่ US
