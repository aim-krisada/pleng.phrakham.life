...
- **⭐ ข้อกำหนดใหม่ P'Aim:** เพลง+พระคำ **ใช้ core เดียวกันเท่าที่ share ได้ (แก้ที่เดียว)** → SA ประเมิน shared token layer (Vue↔Quarto) + ออกแบบก่อนเขียน DS parity · brief `docs/pm/brief-phrakham-parity.md`
- **จ่ายแล้ว:** send_message SA (สายเดิม) → เขียน `docs/ds/phrakham-parity.md` (ส่วน Shared-core + DS B-1..B-6 + AC) · **รอ P'Aim เคาะ shared-core ก่อน Dev ลงมือ**
