...
- **🐞 บั๊ก repeat (พี่เปา) — รอ P'Aim ยืนยันคำทวนก่อนจ่าย** · อาการ: กดจุดหนึ่งในโน้ต → เล่นจากจุดกดถึงจบเพลง → วนกลับมาที่จุดกด (ผิด) · ต้องการ: เริ่มที่จุดกด (ถูก) แต่ **วนตามท่อนที่กำหนดตอนเลือกท่อนเพลง** ไม่ใช่วนจุดกด→จบ · เกี่ยว B102 play-order/loop · ยังไม่ dispatch
