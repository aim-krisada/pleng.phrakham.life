...
- **🐞 บั๊กพี่เปาชุดใหม่ (survey ทั้งโฟลเดอร์ 13 ก.ค.):**
  ...
  - **issues2 เอื้อน vs slur** (`6_5_`/`1'_7_` ลากติดแต่ไม่ใช่ slur · เพลง "ในโลกนี้") → **ทำต่อในสาย tie Dev เดียวกัน** (ยืนยันไปแล้ว · queued) · อาจต้อง define notation เอื้อน (คุย DA/model — รอ report)
