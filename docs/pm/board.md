...
- **B105 (dev) ปุ่มเล่น UX** — จ่าย dev (branch `b105-play-ux` · `task_852d3c26`) · (1) สลับโหมดเสียง real-time เหมือนเปลี่ยนคีย์ (2) เล่นทั้งเพลงครั้งแรก default ติ๊กท่อนหมด (ตรวจ reasonableness) · ต่อยอด B104 · รั้ว SingTransport/SongViewer/store+test · brief `brief-b105-play-ux.md` · ▶ dev→tester→deploy
- **B106 (SA R&D) เสียงคอร์ดเพราะขึ้น + สมดุล gain** — จ่าย SA (branch `b106-sa-chord-quality` · `task_de40ce42`) · P'Aim: คอร์ดดังไปไหม + อยากได้ voicing เพราะมากๆ (ทฤษฎีดนตรี+โปรแกรมขั้นสูง) · SA สำรวจ+เสนอ 2-4 ตัวเลือก (inversions/voice-leading/arpeggio/tensions/gain) + เดโมให้ฟังถ้าได้ → PM เสนอ P'Aim เลือก → dev · เชื่อม voicing v2 · deliverable `docs/ds/chord-voicing-quality.md` · brief `brief-b106-sa-chord-quality.md`
