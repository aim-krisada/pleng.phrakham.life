...
- **🐞 บั๊ก triplet+tie (พี่เปา issues1) — จ่าย Dev แล้ว** spawn_task `task_6ff2cbb9` · brief `docs/pm/brief-bug-triplet-tie.md` · (1) เลข 3 triplet ชัดขึ้น (2) tie โยงเลข→เลข ไม่ขาด (recurring · เพลง "ของขวัญ") · แก้ end-to-end data+render อย่าเด้ง lane · ล็อกอิน team render จริง · **kanban พี่เปาย้าย→ 2-กำลังทำ + อัปเดตตารางแล้ว**
...
- **จ่าย Tester แล้ว** — spawn_task chip `task_0382ba9a` · brief `docs/pm/brief-phrakham-parity-qa.md` · gate DS AC เต็ม + **3 live checks (ต้องล็อกอิน team เปิดแผ่นเพลงจริง):** chip pill 20px · แผ่นเพลง no-regression · ปุ่มรอง hover · **ถ้า Tester ล็อกอินไม่ได้ = PM ขอ credential P'Aim**
