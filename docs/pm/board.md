...
| **edit-dev `wt-edit-fix`** | `fc8122c` | ✅ **เสร็จ round 1 · รอ PM ตรวจ DoD** (report `docs/reports/wt-edit-fix.md`) — **B048** default=ต่อกัน (`ref('flow')`) ✅ พิสูจน์เบราว์เซอร์ · **B050** เนื้อหายแก้แล้ว (`barContent` ป้อนพยางค์ lens) ✅ เบราว์เซอร์เพลงจริง 122 พยางค์โผล่ · **B051** ป้าย section เฉพาะห้องแรก/บรรทัด ✅ unit · **test 115/115 · build ผ่าน** · **B049** = รายงาน gap (ในreport §B049): built มี "ลำดับเพลง" ตารางดิบล่างเพจ ที่ prototype ไม่มี (prototype แยก พิมพ์เนื้อ↔จัดเรียง) → **PM ตัดสิน** เก็บ/redesign/ผสม · **🟢 SongSheet.vue ไม่ถูกแตะ → ไม่ชน B043 เฟส 2 · merge อิสระได้** (สอบตาม brief แล้ว: preview *ใช้* SongSheet แต่ fix อยู่ใน EditorMode ล้วน) · **ห้ามแตะไฟล์ B043** = ทำตามครบ · port 5325 (kill orphan IPv6 เก่าก่อน) | debug pl2 r1 |
