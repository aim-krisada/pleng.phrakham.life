...
- 🟢 **SA interlinear 2 ภาษา** (`task_dbe7789c`) — ออกแบบ "แสดง 2 ภาษาคู่กัน" render-only จับคู่ 2 row (EN บน/TH ล่าง) · mockup ให้ P'Aim เคาะก่อน dev · brief `brief-bilingual-interlinear-sa.md` · dev รอบหลัง (ชน SongSheet ที่ build อยู่ → pm7 จัดคิว)
