...
- **B055 ด่วน (chip `task_7808c3a5` · wt-b055 · 5360)** — โหมดแก้ไขขึ้นแดง "จังหวะไม่ครบ" ปลอม (จังหวะข้ามห้อง/บรรทัด · pickup) · มีกลไก `line.cont`+checkbox อยู่แล้ว investigate+แก้ให้ครอบ · brief `brief-b055-cross-bar-beat.md` · แตะ EditorMode.vue (ระวังถ้า mobile เริ่ม)
