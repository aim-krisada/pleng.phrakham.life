...
| **DA import `da-import`** | — | 🔨 **จ่ายแล้ว (chip `task_a194aafa`)** brief `brief-da-import.md` · 120 เพลงใหม่ (PDF+DOCX) → **v2 · upsert ตามเลข · ทับของเก่า** · **step-by-step + GATE:** ① วิเคราะห์ PDF vs DOCX → 🚦 ② parser+นำร่อง+risk+backup → 🚦 ③ P'Aim run SQL · data/tooling ไม่ชน UI | debug pl2 r1 |
