...
- **B101 คัดลอก/วางบรรทัด-ห้อง ยืดหยุ่น — 🟠 tester CONDITIONAL · แก้ B2 ก่อน deploy** (branch `b101-copy-paste-flexible` · code `2d32af4` · dev `local_d3a5e953`) · tester ผ่าน fence/test/build/desktop + wording ชัด + B098 ไม่พัง · **P'Aim เคาะ:** B1 (เนื้อไม่ตามไปตอนวางท่อนใหม่=melody-only) → **รับ melody-only** (โค้ดถูก · "เอาเนื้อไปด้วย"=follow-up) · B2 (มือถือ เมนู ⋯ หลุดขอบ ทางเข้า copy-line) → **แก้ก่อน deploy** (clamp `.sb-dropdown`) · **ส่งกลับ dev แก้ B2** → tester re-check มือถือ → PM cherry-pick `2d32af4`+fix → deploy · report `docs/reports/tester-b101-copy-paste-flexible.md`
