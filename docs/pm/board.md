...
- **B107 ระบบเสียงเครื่องดนตรีจริง — ✅ P1 เสร็จ (แก้ loading ตรง P'Aim) · จ่าย tester** (branch `b107-instrument-playback` · dev `local_6536bc34` · tester `task_14200ba0`) · **P1 = เปียโน Grand จริง (Splendid PD · 3.23MB · lazy) แทน synth B104 + แก้คอร์ดดังไป (voice-leading+bus+gain) กลืนในตัว** · **loading = รอโหลด+progress pill "🎹 กำลังโหลด NN%" (30 tick monotonic) · synth เฉพาะโหลด fail · กดพัก=ยกเลิก+cache** (ตรง P'Aim) · 436 test + build · **tester: ทาง editor anon (ไม่ล็อกอิน)+มือถือ+regression · by-ear ขั้นสุด=P'Aim ฟัง live ก่อน deploy** · synth→piano=ฟีเจอร์ · **P2 presets+arranger · P3 MP3 · mirror host = รอบถัดไป**
