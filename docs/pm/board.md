...
- **B107 ระบบเสียงเครื่องดนตรีจริง — 🟠 P1 DEV เสร็จ · ส่งกลับปรับพฤติกรรมโหลด ก่อน gate** (branch `b107-instrument-playback` · dev `local_6536bc34`) · **P1 = เปียโน Grand จริง (Splendid PD · 30 ogg 3.23MB · lazy) แทน synth B104 + แก้คอร์ดดังไป (voice-leading+bus+gain) กลืนในตัว** · 436 test + build · โหลดเย็น ~4วิ/warm ~0.5วิ · **⚠️ discrepancy: P1 ทำ "synth-ระหว่างโหลด" (PM เคาะรอบแรก) แต่ P'Aim เปลี่ยนเป็น "รอโหลดครบ+progress แบบ MP3" → ส่งกลับ dev แก้ก่อน (PM ถอน tester chip เดิม)** · re-gate หลังแก้: tester ทาง editor (anon ไม่ล็อกอิน)+pipeline+มือถือ · by-ear ขั้นสุด=P'Aim ฟัง live ก่อน deploy · synth→piano=ฟีเจอร์ · **P2 presets+arranger · P3 MP3 เปียโน · mirror host = รอบถัดไป**
