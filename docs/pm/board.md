...
- **🟢 B107 P1 เสร็จ → ขอ tester gate** (branch `b107-instrument-playback` · report `docs/reports/b107-instrument-playback.md`) · PM เคาะ gate แล้ว (host-agnostic+jsDelivr · Grand default+fallback) · **P1 = เปียโน Grand จริงแทน synth B104 + แก้คอร์ดดังไป (voice-leading+บัส gain) + fallback synth เล่นทันที** · **dev self-verify เบราว์เซอร์จริง:** โหลด 30 ogg **3.23MB** (1 velocity layer ไม่ใช่ 17MB) จาก PD host · fire ทำนอง/คอร์ด/ทรานสโพส ไม่ error · 0 console error · vitest 436 ผ่าน+build ผ่าน · smplr = lazy chunk · **tester ต้อง:** ล็อกอินทีมเปิดเพลงจริง (anonymous ติด GATE 0 เพลง) · ฟังด้วยหู (เปียโนถูก/เพราะ) · มือถือ (`http://10.152.249.98:5307/` เวลาโหลด+fallback ไม่ค้าง) · regression เล่น/หยุด/สลับโหมด/ทรานสโพส/MP3 · **อย่าตี "เสียงเปลี่ยน synth→เปียโน" เป็นบั๊ก = ฟีเจอร์** · **P2/P3 ยังไม่ทำ:** presets+arranger (P2) · MP3 เปียโนจริง (P3 · ตอนนี้ MP3=synth voice-led) · mirror ไฟล์เสียงก่อน production เต็ม
