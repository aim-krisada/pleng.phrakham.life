...
|---|---|---|---|
| dock-polish `wt-dock2` | — | 🔧 **dock-core รอบ 4 (จ่ายแล้ว · P'Aim real-use)** brief `brief-dock-polish.md`: **A** popup ตกขอบ→reposition (core) · **B** ความโปร่ง ซ่อน default เพิ่มเองได้ (core) · **C** เรียง sing default `['play','loop','key','tempo','fdown','fup','display','print']` เอา chord ออก · branch wt-dock2 จากฐาน merged | debug pl2 r1 |
