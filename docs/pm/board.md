...
- **🐞 บั๊ก repeat (= issues4) — P'Aim ยืนยัน + จ่าย Dev แล้ว** `task_61a7827f` · brief `docs/pm/brief-bug-repeat-seek.md` · **requirement ชัด: เมนู "เลือกท่อน" = SSOT ลูป/ลำดับ · คลิกคำ = seek อย่างเดียว (ไม่เขียนทับลูป)** · แก้ที่ transport/playback (B102) · **⚠️ collision SongSheet/NoteRow กับ tie/issues3 Dev → ping PM ถ้าต้องแตะ** · verify ด้วยหู+playhead · kanban issue4 → 🔵 กำลังทำ
