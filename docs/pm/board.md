...
- **B098 แยกเครื่องมือโน้ต/ห้อง — คัดลอก+ลบ ครบ 4** — **จ่าย dev แล้ว (spawn_task 12 ก.ค. · branch `b098-note-bar-tools`)** · อาการ P'Aim: ปุ่ม ✕ กับ ถังขยะ ทำเหมือนกัน = ลบทั้งห้อง · ต้องแยก: คัดลอกโน้ต/ลบโน้ต + คัดลอกห้อง/ลบห้อง (ห้อง=bar) · dev วิเคราะห์+ออกแบบ+แก้เอง · KISS ต่อยอดของเดิม + คงมือถือ B092 · brief `docs/pm/brief-b098-note-bar-tools.md` · **⚠️ ชน `EditorMode.vue` กับ B097/B095 → cherry-pick ทีละงานตอน merge** · ▶ dev→tester→PM merge · **ยังไม่ deploy**
