...
1. **dockkey-dev phase 2 + checklist = ✅ ส่งแล้ว** (ล่าสุด `99911c5` · re-sync `9f2ad42` · **300 test** · build) — 3 หน้าใช้ DockKey engine เดียว (ITEMS_PRINT/EDIT band 21 keys · MP3 `ExportTool` กลาง PDF/JSON/MP3 ครบ 3 หน้า · ถอด StudioDock) · **✅ แก้ P'Aim checklist 11 ก.ค. ครบ (§A engine + §B สิง)**: ทุก popup ชิดขวาตำแหน่งเดียว(gap9)+ไม่มี scroll · ตัด caret · **button hierarchy แก้ต้นตอ (ExportTool ghost · เลิกน้ำตาลโดด)** · B1 time ไม่ซ้อนคีย์(-34→+10) · **B2 ลบ progress fill ที่ทับท่อนไม่เลือก** · B4/B5/B7/B9/B11/B12 · verify DOM สด · report §รอบ checklist (ติ๊กครบ) · **🔺 pm7: tester ตรวจ checklist ก่อน P'Aim ดู → git-verify → P'Aim LAN 3 หน้า ก่อน merge** · dev `http://192.168.1.124:5315`
