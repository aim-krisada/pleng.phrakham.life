...
- **2 คำถามจากเล่มใหญ่ (SA · ไม่เดาปน):** (ก) "อ.NNN" = เลขอนุชนใช่ไหม (SA มั่นใจสูง กำลังเปิด PDF ยืนยัน) (ข) "238=/233=" เขียนมือที่หัว #432/#515 = เลขเล่มไหน · + เพลง (อ.842) ถูกขีดฆ่าแดงในเล่มใหญ่ใบ 335 (ตั้งใจตัด?)
