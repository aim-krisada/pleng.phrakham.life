...
- **🔵 home-tidy ค้างแค่ "ปุ่มสร้างไม่เด่นยังไง" (การ์ด + เอา ⇄ ตัดสินแล้ว):** โจทย์ยาก = create ต้อง **เข้าถึงทุกคน (anon+JSON · ไม่ login-gate) + ไม่เด่น** พร้อมกัน → **P'Aim สั่งปรึกษา N+G → จ่าย (task_ef8eb3c3):** วาง low-freq-but-available action ยังไง (overflow/ไอคอนหัวรายการ/section) desktop vs mobile + discoverability → transcript+ทางเลือกให้ P'Aim · รอ inbox `2026-07-25-createbtn-options.md`
