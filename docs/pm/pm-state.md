...
| **คอร์ด: รองรับทุกคอร์ดมาตรฐาน (พี่เปา · hotfix)** | ✅ เสร็จ+self-verify (`chords-all-standard` @ `8678162` · 774 เทสต์ · real browser) | Tester verify [จ่าย] → **deploy main (รอ P'Aim go)** + port base · caveat: slash-bass transpose = B124 |
