...
- **✅ P'Aim เคาะ (25 ก.ค.): ทำนอง 100% เหมือนกัน · ไม่มีเคสปรับทำนอง** → ตัด caveat N (variant melody) ทิ้ง · design = 1 ทำนอง shared เต็ม + เนื้อหลายชุด สลับแท็บ · **แก้บั๊ก "-" ในตัว** (พี่เปาไม่ต้อง 717-1/-2) · รอ P'Aim สั่ง build/จัดลำดับ
