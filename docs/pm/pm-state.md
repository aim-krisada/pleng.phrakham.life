...
| songbook Thai-flow (B120) | 📋 queue (editor merged แล้ว → เริ่มได้) | — |
...
- ✅ editor → base merge = **ปิดแล้ว** (`3a3e618` · Tester job D PASS: build+804เทสต์+slur 3 ชนิด ≤0.06px+141 ไม่ถอย) → รายละเอียด decisions-log
