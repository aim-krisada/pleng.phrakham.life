...
- **✅ P'Aim เคาะ (25 ก.ค.):** create/นำเข้า JSON = **ปุ่มเล็กหัวรายการ (list-level)** ✅ · **ลบ = ที่การ์ด (ตาม N destructive-separation)** + **ย้าย share + download JSON ไปการ์ดด้วย** → โมเดล **per-song ⋮ บนการ์ด (share/download/ลบ) vs list-level (สร้าง/นำเข้า)** = แยก "ทำกับคลัง" vs "ทำกับเพลงนี้" (Google Drive/Spotify pattern) · 🔎 **open: share/download ย้ายไปการ์ด แล้วยังเหลือในหน้าดูเพลงไหม**
