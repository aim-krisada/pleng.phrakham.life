...
- [ ] pre-merge: **แก้ artifact `"` (เพลง `c71cbe9a`)** [จ่าย editor แล้ว · P'Aim เคาะ ก=fix-first] → Tester spot-verify → **PM merge `editor-usability`→base + auto-housekeep**

## รอ P'Aim/พี่เปา (ไม่บล็อก merge)
- eyeball 5 เพลง "หางทำนองท้ายวรรค" ว่าเอื้อนถูกหรือ over-draw: เวลาก่อสร้างพระวิหาร · ตกอยู่บาบูโลน · อีกไม่นานฯ · ทางแคบ · ทรงเป็นอยู่ในข้า
