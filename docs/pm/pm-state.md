...
- [ ] pre-merge editor: (a) Tester #2 กวาดคลัง melisma over-draw + breakpoints [จ่ายแล้ว] · (b) P'Aim พิมพ์ `song141-align-all3.pdf` จริง · → ครบแล้ว PM merge `editor-usability`→base
