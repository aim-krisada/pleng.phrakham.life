...
- **🔵 รอ P'Aim เคาะ editor:** (1) v2 interlinear → จ่าย UX mockup เลยไหม (2) v1 = กล่องเรียงลงมา/แท็บเดิม · แล้วค่อย build (data มาตรฐาน lyricSets↔MusicXML · รวม 717-1/-2 = SQL P'Aim สั่ง)
...
- **🔎 P'Aim สั่งปรึกษา C+N+G เรื่อง delete/download/share → จ่าย (task_2e0677b3):** per-card world-class? · ย้ายไปการ์ดแล้วยังเหลือในหน้าดูเพลงไหม (โดยเฉพาะ share) · destructive · **สรุปต้องมีหลักการคิด+pros/cons ของ C/G/N แต่ละคน** (memory `feedback_relay_each_recommender_reasoning`) · รอ inbox `2026-07-25-percard-actions-options.md`
- **แล้ว bundle home-tidy 1 ก้อน** (การ์ด + create/นำเข้าหัวรายการ + per-card ⋮ + เอา ⇄/"รุ่นทดลอง" ออก) → UI preview → P'Aim ดู ก่อน build
