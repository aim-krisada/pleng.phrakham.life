...
- 🎯 **เฟส POLISH (P'Aim สั่ง · ทุกงาน world-class + G consult บังคับ ผ่าน ai-bridge Chrome :9335):**
  ...
  - 🔴 **BI-011b slur `( )` ลบไม่ได้ = bug** — chip `task_f2529e5c` (base bi011 @4764b28 · แก้ toggle-off slur + G ให้ลบทั้ง pair · **พิสูจน์ slur JSON before/after จริง** ไม่เคลมเหมือนเดิม)
