...
- [ ] **slur "แห่ง" geometry bug** (ไม่ใช่ over-draw/ลบ — PM เคยอ่านผิด แก้แล้ว): เส้น slur ปลายซ้ายยาวเกิน ล้นเลข "3" ข้ามบาร์ · ต้องจบ center หัวโน้ต (เหมือนเส้นอื่น · engraving std) · [จ่าย editor] หาต้นเหตุ (โน้ตแรกหลังบาร์?) + blast radius · ไม่บล็อก merge P2
