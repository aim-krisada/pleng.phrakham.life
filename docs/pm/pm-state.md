...
- **✅ P'Aim สั่ง "717 build" → จ่าย (task_7b141527):** ก้าวแรก = **scope + UI preview (component จริง) + แผนข้อมูล (รวม 717-1/-2→717 · ⛔ ไม่แตะ DB) + feasibility v1 vs v2 (P'Aim สั่งลงทั้งคู่) → STOP ให้ P'Aim ดู UI ก่อน implement** · เฟส 2 = build+test หลัง go · รอ inbox `2026-07-25-717-scope.md`
