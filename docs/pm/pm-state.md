...
- [ ] pre-merge editor: (a) Tester #2 กวาดคลัง melisma over-draw + breakpoints — **🔨 กำลังรัน** (Tester วัด worst-case arc) · (b) ✅ P'Aim + พี่เปา OK `song141-align-all3.pdf` (พิมพ์จริง) · → เหลือ (a) เขียว → PM merge `editor-usability`→base + auto-housekeep
