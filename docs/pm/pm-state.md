...
- **ค้าง (หลัง G+N v1/v2 + P'Aim ok):** build — **v2 editor = interlinear (standard)** · **v1 editor = simple/เร็วสุด** · view/สลับ ทั้ง 2 รุ่น · data มาตรฐาน (lyricSets↔MusicXML) · รวม 717-1/-2 (SQL · P'Aim สั่ง · อ่าน DB ก่อน)
