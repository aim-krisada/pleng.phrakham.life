...
### ☑️ CHECKLIST บังคับ — PM ต้องใส่ในทุกใบสั่งงานที่มีการตัดสินใจออกแบบ
**(PM ลืม 2 ครั้งแล้ว · P'Aim ทักเอง 24 ก.ค. "การออกแบบ อย่าลืมให้เอสเอคุยกับจีนะ" → นี่คือการแก้ที่กระบวนการ ไม่ใช่จำเอา)**
1. **คุย G ก่อนตัดสินใจออกแบบทุกครั้ง** (ไม่ใช่ทางเลือก) · 2. **เซฟ transcript เต็มลง disk → path ใน `EVIDENCE`** (เล่าลอยๆ = ไม่นับ ปิด gate ไม่ได้) · 3. **ชื่อแชต `pleng-<หัวข้อ-อังกฤษ>-YYYY-MM-DD`** (P'Aim เปิดอ่านเองได้) · 4. **ติด Sign in → เรียก P'Aim ผ่านป้าย `C:\gl\pm-inbox\_ขอความช่วยเหลือ\README.md` เองได้เลย ไม่ต้องผ่าน PM** ⛔ ห้ามกรอกรหัสผ่าน · 5. ⛔ **อย่าคุยแบบขอตรายาง** ตามต่อ 1-2 รอบถ้าคำตอบกว้าง · **G เคย hallucinate จนถอนคำ 2 ครั้ง → ตรวจเองก่อนใช้**
