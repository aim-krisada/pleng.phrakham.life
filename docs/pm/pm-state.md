...
| **editor → base merge** | ✅ **merged `3a3e618`** (code auto-merge สะอาด · conflict แค่ 2 doc เก็บ base) · Tester job D verify merged base [จ่าย] | เขียว = ปิด gate · แดง (B118+editor slur ชน semantic) = จ่ายแก้ |
...
- [ ] **editor merged `3a3e618` → verify merged base** [Tester job D จ่าย] — ยืนยัน B118+editor slur อยู่ร่วมกันถูก + build + suite เขียว → ปิด gate
