...
- **โมเดล v2 รองรับหลักการ** (แยก stanza/verse) · **จ่าย G+N consult (task_3fd438cd):** มาตรฐาน (MusicXML/MEI) จัดการยังไง · ต่างจาก verse ต่อเนื่องยังไง · UX สลับเนื้อ · identity/เลข → transcript+ทางเลือกให้ P'Aim · รอ inbox `2026-07-25-multilyric-options.md`
...
## 🔴 กฎใหม่ (P'Aim 25 ก.ค. pm48): FIX ต้องครอบทั้ง v1 + v2
- **จากนี้ทุก fix เล็กๆ (search/หน้าแรก/ฯลฯ) = ลงทั้ง root (v1) และ /v2** · v1 เดิม frozen (v1-frozen 16906d8) → **เลิก frozen · กลายเป็น "แก้คู่กัน" · deploy 2 ที่** · ทุกใบสั่ง fix ต้องระบุไฟล์ v1&v2 (ถ้าโค้ดเดียวกัน=แก้ครั้งเดียว deploy 2 ที่ · ต่าง=แก้ทั้งคู่) · ⚠️ **รอ P'Aim confirm ความเข้าใจนี้ก่อน lock ถาวร**

## 🔎 พี่เปา: search ไม่ดี (25 ก.ค. pm48) — จ่ายตรวจแล้ว task_2764707d
- ค้นเนื้อ "ยามพระเจ้าอยู่ร่วมกับพวกเรา" ต้องพิมพ์ยาวมากกว่าจะเหลือ 3 เพลง · พี่เปาเดา: เจอเพลงมีคำกระจายๆ ปน · **อยากให้คำติดกัน (วลี) ขึ้นก่อน** · session ตรวจ read-only (songSearch.js v1+v2) → ยืนยันสาเหตุ + เสนอ phrase-first ranking → **เอามาให้ P'Aim อนุมัติก่อนแก้จริง** · รอ inbox `2026-07-25-search-phrase-ranking.md`
