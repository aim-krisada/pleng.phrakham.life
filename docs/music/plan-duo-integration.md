...
## 🔸 การตัดสินใจที่ต้องเคาะ (P'Aim)
1. **default เสียงตอนเปิดเพลง = Piano หรือ Duo?** (แนะนำ: Piano เป็น default · Duo เป็นตัวเลือก — กันคนเน็ตช้าโหลด sample เชลโลโดยไม่ตั้งใจ · หรือถ้าอยากให้ทุกคนได้ยิน duo = default duo)
2. **ทุกเพลงมี duo ไหม?** — สูตรกลาง = ได้ทุกเพลงอัตโนมัติ (แนะนำ: ทุกเพลง)
3. **ตัดเสียงอื่นทิ้งเลยไหม** (ออร์แกน ฯลฯ ใน soundOptions) — P'Aim บอก "เหลือแค่ 2" = ตัด (ยืนยัน)
4. **chamber reverb เอาไหม** (G แนะนำ · ยังไม่เคาะ) — ต้องฟังก่อนเพราะกระทบเปียโนด้วย
