...
--    EXACTLY this song. Matching the TITLE alone is not enough: same title + edited
--    content would have been overwritten silently (fixed 27 ก.ค.).
do $$
begin
  if exists (
